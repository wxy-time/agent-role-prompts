...
[公开示例](EXAMPLES.md) · [协议评估](EVALUATION.md) · [贡献指南](CONTRIBUTING.md) · [变更记录](CHANGELOG.md)
...
- [公开示例](EXAMPLES.md)包含 3 个合成场景，不来自真实客户或私有项目。
- [协议评估](EVALUATION.md)包含 6 项静态检查，每个验证级别 2 项。
...
提交前请遵循[贡献指南](CONTRIBUTING.md)。本项目采用 [MIT License](../../LICENSE)。
