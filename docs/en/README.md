...
- Small single-unit STANDARD tasks can skip the independent plan review; the scheduler checks the plan before dispatch, while high-risk changes keep the review.
